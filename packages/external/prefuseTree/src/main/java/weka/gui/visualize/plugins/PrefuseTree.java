...
public class PrefuseTree
  ...
  public static class DottyToTree {
    ...
    protected void writeHeader(BufferedWriter writer) throws Exception {
      ...
      writer.newLine();
      // the dtd available from nomencurator.org seems to have packed a sad, hence a new one.
      ...
      writer.write("<!DOCTYPE tree SYSTEM \"http://www.cs.umd.edu/hcil/iv03contest/datasets/treeml.dtd\">"); 
      writer.newLine();
